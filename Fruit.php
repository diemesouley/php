...
<p>Ajouter des produits</p>
      <form action="enregistrerPro.php" method="POST">
      ...
      <p>Liste des Fruits</p>
       ...
       <?php
         ...
         ?>
                    ...
                    <p>Supression de fruits</p>
      <form action="supprimerPro.php" method="POST">
            <input type="text" placeholder="Entrer le nom que vous supprimer" name="nom" required/>
            <input type="submit" value="Supprimer" />
        </form>      

        <p>modifier données fruits</p>
      <form action="modifier.php" method="POST">
            <input type="text" placeholder="Entrer le nom que vous modifier " name="nom" required/>
            <input type="submit" value="Envoyer_nom" />
        </form>      
</body>
</html>